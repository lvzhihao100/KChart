...
//                }
     ...
     * 设置down颜色
     */
    public void setMainDownColor(int color) {
        mMainDraw.setDownColor(color);
        mVolumeDraw.setDownColor(color);
    ...
    public void setRedUpAndGreenDown(boolean isTrue) {
        if (isTrue) {
            ...
            mMainDraw.setUpColor(R.color.chart_green);
        }
    }
