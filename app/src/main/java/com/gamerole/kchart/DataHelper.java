...
public class DataHelper {
     ...
     * @param datas
     */
    static void calculateRSI(List<Stock> datas) {
        float rsi1 = 0;
        float rsi2 = 0;
        float rsi3 = 0;
        float rsi1ABSEma = 0;
     ...
     * @param datas
     */
    static void calculateKDJ(List<Stock> datas) {
        float k = 0;
        float d = 0;
     ...
     * @param datas
     */
    static void calculateMACD(List<Stock> datas) {
        float ema12 = 0;
        float ema26 = 0;
        float dif = 0;
        float dea = 0;
...
//            用（DIF-DEA）*2即为MACD柱状图。
     ...
     * @param datas
     */
    static void calculateBOLL(List<Stock> datas) {
        for (int i = 0; i < datas.size(); i++) {
            Stock point = datas.get(i);
            final float closePrice = point.getClosePrice();
            if (i == 0) {
     ...
     * @param datas
     */
    static void calculateMA(List<Stock> datas) {
        float ma5 = 0;
        float ma10 = 0;
        float ma20 = 0;
    ...
    private static void calculateVolumeMA(List<Stock> entries) {
        float volumeMa5 = 0;
        float volumeMa10 = 0;

        for (int i = 0; i < entries.size(); i++) {
            Stock entry = entries.get(i);
